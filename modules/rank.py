...
# print_rank("nome_dataset.csv", id_oggetto, [lista, di, utenti])
# -----------------------------------------------------------
...
#Prototipo di chiamata del metodo:
#print_rank((path database), (oggetto del quale calcolare il rank), (lista degli utenti da considerare nel calcolo del rank))
#Esempio: print_rank(db_1.csv, 01111111, [00000001, 02245645, 9994524])
...
def print_rank(database, item, users_list):

    data=check(database, item, users_list)
